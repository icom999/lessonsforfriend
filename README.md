...
2. После создания нового файла с раширением .py Питона для выполнения задания у нас в Visual Studio Code этот <img align="right" width="60" height="25" src="https://github.com/icom999/lessonsforfriend/raw/Testgithubcolloboration/IMG/green_file.svg?sanitize=true"> подсветиться зеленым.
